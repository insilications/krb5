...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630102820
...
%reconfigure --with-system-es --with-system-et --with-ldap --disable-shared \
--enable-static \
--with-system-es \
--with-system-et \
--with-ldap \
...
%reconfigure --with-system-es --with-system-et --with-ldap --enable-shared \
--with-system-es \
--with-system-et \
--without-ldap \
--disable-gcc-warnings \
